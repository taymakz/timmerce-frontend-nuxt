        ...
        <div class="relative group">
          ...
          >
            <swiper-slide v-for="(banner, index) in banners" :key="index">
              <NuxtLink :to="banner.url" :external="banner.external_url" :target="banner.external_url ? '_blank' : '_self'">
                <NuxtImg placeholder loading="lazy" :alt="banner.title" :src="getMediaUrl(banner.normal_banner)" class="hidden sm:block aspect-[2/1] object-cover md:aspect-[4/1] lg:aspect-auto max-h-[400px] w-full" />
